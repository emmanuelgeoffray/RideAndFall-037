...
void pyr_yape06::compute_laplacian(IplImage * smoothed_image)
{
  ...
  if (w == 88 && h == 68)
    ...
    compute_laplacian(smoothed_image, laplacian, 384, 304, R, R * 384, Rp + Rp * 384, Rp - Rp * 384);
  else if (w == 192 && h == 152)
    compute_laplacian(smoothed_image, laplacian, 192, 152, R, R * 192, Rp + Rp * 192, Rp - Rp * 192);
  else if (w == 352 && h == 272)
    ...
    compute_laplacian(smoothed_image, laplacian, 96, 76, R, R * 96, Rp + Rp * 96, Rp - Rp * 96);
else if (w == 48 && h == 38)
	compute_laplacian(smoothed_image, laplacian, 48, 38, R, R * 48, Rp + Rp * 48, Rp - Rp * 48);		
  else if (w == 176 && h == 136)
